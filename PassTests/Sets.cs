...
namespace PassTests
{
    ...
    public class Sets
    {
        ...
        public void IntMax()
        {
            ...
            var upper = SetExtensions.GetUpperBounds<int>(set, (x, y) => x < y);
        ...
        public void Subset()
        {
            ...
            var upper = new HashSet<HashSet<int>>(SetExtensions.GetUpperBounds<HashSet<int>>(set, (x, y) => x.All(item => y.Contains(item))), HashSet<int>.CreateSetComparer());
