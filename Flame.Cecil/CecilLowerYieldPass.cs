...
namespace Flame.Cecil
{
    ...
    public class CecilLowerYieldPass : LowerYieldPassBase
    {
        ...
        public override void ImplementEnumerable(IEnvironment Environment, DescribedType TargetType, IType ElementType, IStatement GetEnumeratorBody)
        {
            ...
            descGenericGetEnumeratorMethod.AddAttribute(PrimitiveAttributes.Instance.InlineAttribute);
            ...
            descGetEnumeratorMethod.AddAttribute(PrimitiveAttributes.Instance.InlineAttribute);
        ...
        public override void ImplementEnumerator(IEnvironment Environment, DescribedType TargetType, IType ElementType, IStatement MoveNextBody, IStatement GetCurrentBody)
        {
            ...
            descMoveNextMethod.AddAttribute(PrimitiveAttributes.Instance.InlineAttribute);
            ...
            descGenericCurrentGetAcc.AddAttribute(PrimitiveAttributes.Instance.InlineAttribute);
            ...
            descOldCurrentGetter.AddAttribute(PrimitiveAttributes.Instance.InlineAttribute);
        ...
        {
            return Method.MakeRecursiveGenericMethod(Method.GetRecursiveGenericParameters());
        }
