...
namespace UnitTests
{
    ...
    public class TypeSystemTests
    {
        ...
        {
            var descType = new DescribedType(new SimpleName("X"), null);
        ...
        {
            var descGenericType = new DescribedType(new SimpleName("G"), null);
        ...
        {
            var descType = new DescribedType(new SimpleName("Herp"), null);
        ...
        {
            var descBaseType = new DescribedType(new SimpleName("Herp"), null);
            descBaseType.AddAttribute(PrimitiveAttributes.Instance.ReferenceTypeAttribute);

            var descDerivedType = new DescribedType(new SimpleName("Derp"), null);
        ...
        {
            var descEnumerable = new DescribedType(new SimpleName("IEnumerable", 1), null);
